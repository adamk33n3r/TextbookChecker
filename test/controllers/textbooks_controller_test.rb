...
class TextbooksControllerTest < ActionController::TestCase
  ...
  test "should create textbook" do
    assert_difference('Textbook.count') do
      post :create, textbook: { authors: @textbook.authors, date: @textbook.date, edition: @textbook.edition, isbn: @textbook.isbn, price: @textbook.price, title: @textbook.title }
    end
  ...
  test "should update textbook" do
    patch :update, id: @textbook, textbook: { authors: @textbook.authors, date: @textbook.date, edition: @textbook.edition, isbn: @textbook.isbn, price: @textbook.price, title: @textbook.title }
    assert_redirected_to textbook_path(assigns(:textbook))
  end
