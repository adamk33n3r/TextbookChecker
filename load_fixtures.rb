...
@c.save
@t=@c.textbooks.create(title:"Brave New World",authors:"Aldous Huxley",edition: "1",published:Date.new(1932),price:9.99,isbn:"9780060929879",description:"This is a description of Brave New World",image_url:"http:/files.adam-keenan.net/Images/Geff2.gif")
