class AddDeviseToStudents < ActiveRecord::Migration
  def self.up
    change_table(:students) do |t|
      ...
      t.remove :password_digest, :verified
    end
  ...
  def self.down
    ...
    change_table(:students) do |t|
      ## Database authenticatable
      t.change :email, :email,      :null => false, :default => ""
      ...
      t.add :password_digest, :string
      t.add :verified, :boolean
    end

    remove_index :students, :email,                :unique => true
    remove_index :students, :reset_password_token, :unique => true
    remove_index :students, :confirmation_token,   :unique => true
    remove_index :students, :unlock_token,         :unique => true
  end
end
